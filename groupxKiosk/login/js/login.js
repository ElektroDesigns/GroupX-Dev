...
$('.modal-dialog').width('75%');
			...
			$.post('groupxMain/model/events.class.php',dataString);
			$.post('groupxMain/command/cal_events2.php',dataString);
 ...
 /* #####################################################################
   ...
   ##################################################################### */
    ...
    $("form").submit(function () {
        switch(this.id) {
            case "login-form":
                var $lg_username="jrtrainer";
                var $lg_password="pass123";
			...
			$("#kioskvid")[0].pause();
                   $("#browser li").each(function() {
					...
					$(this).data('Object', eventObject);
						...
						$('.tile__play').removeClass( 'ui-draggable' );
