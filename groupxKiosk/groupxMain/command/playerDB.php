...
$password = 'austin67';  
$database = 'LakeNona';
$eventtable ='lakeNona_groupxroom_events';
...
// Query the database.
$str_query = 'SELECT * FROM `lakeNona_groupxroom_events` WHERE time_start <= DATE_ADD(NOW() + interval +1 hour, INTERVAL 1 HOUR) and time_end >= DATE_ADD(NOW() + interval +1 hour, INTERVAL 1 HOUR) and date_start = CURDATE()';  
if (!$str_query) {
