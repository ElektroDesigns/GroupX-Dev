...
if(empty($err)) {
	...
	//	echo "<h3>Thank You</h3> We received your submission.";
		...
		$mail->setFrom('test@groupondemand.com', 'Lake Nona');     //Set who the message is to be sent from
...
global $link;	
	...
	$rs_check = mysqli_query($link, "select count(*) as total from users where user_email='$user_email' OR  user_name='$user_name'") 
		or die(mysql_error());
	list($total) = mysqli_fetch_row($rs_check);
