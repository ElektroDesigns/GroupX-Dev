...
$rs_check = mysqli_query($link, "SELECT id from users where md5_id = '$user' and activation_code = '$activ' ") or die (mysql_error()); 
...
if(empty($err)) {
	$rs_activ = mysqli_query($link,"update users set approved='1' WHERE md5_id = '$user' AND activation_code = '$activ' ") or die(mysql_error());
