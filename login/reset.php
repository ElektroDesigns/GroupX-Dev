...
<td class="mcnTextContent" style="padding: 9px 18px; font-family: Tahoma,Verdana,Segoe,sans-serif; font-size: 24px; mso-table-lspace: 0pt; mso-table-rspace: 0pt; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color: #606060; line-height: 110%; text-align: left" valign="top">
<div dir="ltr" style="transform-origin: 0% 0%; left: 231.04px; top: 93.11px; font-family: sans-serif; font-size: 16.43px; transform: rotate(0deg) scale(0.948939, 1)">Thank you for registering with us.<br> Here are your login details...<br>
<a  style="font-size: 23.43px;" href="http://<?php echo $host;?><?php echo $path;?>/activate.php?user=<?php echo $id;?>&activ_code=<?php echo $activ_code;?>"><h4>*****Activate Your Account HERE *****<h4></a>
<br>
Your Username: <span style="font-weight:bold"><?php echo $user_username;?></span><br>
Your Password:<span style="font-weight:bold"><?php echo $pass;?></span>
<br></br>
<h4>*****LOGIN HERE****<h4>
<h3>http://ppymca.groupxnow.com/</h3>
<br></br>
Thank You<br>
</div>
