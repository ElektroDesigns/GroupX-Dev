<?php /*versio:3.02*/ /*************** PHP LOGIN SCRIPT V 2.3*********************
...
$groupx_ClassTable = 'trilakes_groupx_classes';
$live_ClassTable = 'trilakes_live_classes';
$site = 'groupxMain';
...
/*************** reCAPTCHA KEYS****************/
$publickey = "6LcDa_0SAAAAAIq4HPpf4efm9vdR35kwn-QTk7Vf";
$privatekey = "6LcDa_0SAAAAAIIvPMMIPZ481owSZvwSx51mjzyz";
...
/* We also do authentication check of the `ckey` stored in cookie matches that stored in database during login*/
	 ...
	 if( !empty($ckey) && is_numeric($_COOKIE['user_id']) && isUserID($_COOKIE['user_name']) && $_COOKIE['user_key'] == sha1($ckey)  ) {
		...
		/* query user level from database instead of storing in cookies */	
		  list($user_id) = mysqli_fetch_row(mysqli_query($link,"select user_id from users where id='$_SESSION[user_id]'"));
...
else if($_SESSION['user_level'] == SUPER_LEVEL) {
return 1;
} else { return 0 ;
}
