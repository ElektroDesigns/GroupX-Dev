...
<link rel="stylesheet" type="text/css" href="groupxMain/bootstrap/css/bootstrap-datepicker3.min.css" media="screen" >
...
<body class="demo5 preload stretched">
	<a  href="#" style="width=200px;height=20px"class=" md-click md-setperspective button-border button-light button-rounded button-large noleftmargin nobottommargin" data-modal="md-1" ></a>
<div class="modal-wrap md-effect-5" id="md-1" >
	<div class="md-content">
		<div class="form-wrap">
            ...
            <form id="login-form">
                <input type="text" id="login_username" name="username" placeholder="jrtrainer" required />
                <input type="password" id="login_password" name="password" placeholder="pass123" required />
			...
			<div class="force-full-screen full-screen dark section nopadding nomargin noborder ohidden">
				<div class="container clearfix">
					<div class="slider-caption slider-caption-center"style="margin-top:22%;">
						<a id="userLogin" data-login="user" data-animate="fadeInUp" data-delay="400" href="#" style="text-decoration:none" class="button  button-border button-light button-rounded button-large noleftmargin nobottommargin" style="margin-top: 30px;">Start a Workout</a>
						...
						<a data-animate="fadeInUp" data-delay="800" href="#" style="text-decoration:none"class="button md-click md-setperspective button-border button-light button-rounded button-large noleftmargin nobottommargin" data-modal="md-2" style="margin: 30px 0 0 10px;">Create Account</a>
					</div>
				</div>
			...
			<div id="container">
             <div id="main" role="main">
				...
				<div class="panel-group" id="accordion">
                    ...
                    <!-- Category -->
					<div id="collapseTwo"  data-toggle="collapse" class="panel-collapse1 collapse" data-row="1" >
						
						<div class="category "data-row="1"><p style="margin-top:-10px;padding-left:10px">Spinning</p>
							<ul id ="groupxSpin"value ="1"class="categoryRow clearfix"></ul>
						</div>
					</div>
                   <!-- Category -->
					...
					<div id="groupxRoom"  data-toggle="collapse" class="panel-collapse collapse"data-row="3">
						...
						<div class="category "data-row="3"><p style="margin-top:-10px;padding-left:10px">YMCA Instructor Classes</p>
							<ul id ="liveMP" value="3"class="categoryRow clearfix"></ul>
						</div>
                    </div>
					<div id="groupxRoom"  data-toggle="collapse" class="panel-collapse collapse"data-row="3">
	...
	<div id="dialog-message" style="display: none;">
		...
		<div class="form-group">
                <label class=" control-label" for="title">Title </label>
                  <div class="">
                  <input id="edited_title" class="form-control" type="text" >
                  </div>
        </div>
		 <span class="" >
		<div class="form-group">
...
<input type="hidden" id="my_hidden_input">
	...
	<script type='text/javascript' src="groupxMain/bootstrap/js/bootstrap-datepicker.min.js"></script>
